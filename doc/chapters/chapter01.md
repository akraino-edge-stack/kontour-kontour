...
| 26   | KT_KPI_K8S_CONF_E2E_SIG_AUTH                   | API      | Kubernetes conformance for sig-auth                                                   | Compliance %                       |
| 27   | KT_KPI_K8S_CONF_E2E_SIG_STORAGE                | API      | Kubernetes conformance for sig-storage                                                | Compliance %                       |
| 28   | KT_KPI_K8S_CONF_E2E_SIG_INSTRUMENTATION        | API      | Kubernetes conformance for sig-instrumentation                                        | Compliance %                       |
| 29   | KT_KPI_K8S_CONF_E2E_SIG_APPS                   | API      | Kubernetes conformance for sig-apps                                                   | Compliance %                       |
| 30   | KT_KPI_K8S_CONF_E2E_SIG_CONFORMANCE            | API      | Kubernetes conformance for Conformance                                                | Compliance %                       |
| 31   | KT_KPI_K8S_CONF_E2E_SIG_NODE_CONFORMANCE       | API      | Kubernetes conformance for NodeConformance                                            | Compliance %                       |
| 32   | KT_KPI_K8S_CONF_E2E_SIG_API_MACHINERY          | API      | Kubernetes conformance for sig-api-machinery                                          | Compliance %                       |
| 33   | KT_KPI_K8S_CONF_E2E_SIG_NETWORK                | API      | Kubernetes conformance for sig-networrk                                               | Compliance %                       |
| 34   | KT_KPI_K8S_CONF_E2E_SIG_CLI                    | API      | Kubernetes conformance for sig-cli                                                    | Compliance %                       |
| 35   | KT_KPI_K8S_CONF_E2E_SIG_SCHEDULING             | API      | Kubernetes conformance for sig-scheduling                                             | Compliance %                       |
...
| 45   | KT_KPI_OS_REFSTACK                             | API      | OpenStack API compliance based on RefStack guidelines                                 | Compliance %                       |
| 46   | KT_KPI_OS_API_TEMPEST_NOVA                     | API      | OpenStack Nova API functional verification                                            | Compliance %                       |
| 47   | KT_KPI_OS_API_TEMPEST_NEUTRON                  | API      | OpenStack Neutron API functional verification                                         | Compliance %                       |
| 48   | KT_KPI_OS_API_TEMPEST_GLANCE                   | API      | OpenStack Glance API functional verification                                          | Compliance %                       |
| 49   | KT_KPI_OS_API_TEMPEST_CINDER                   | API      | OpenStack Cinder API functional verification                                          | Compliance %                       |
